...
immcolor = "#e6194b";zeropagecolor = "#3cb44b";absolutecolor = "#0082c8";mixed = "#f58231";
...
plot './defaultDat.dat' using 2:xtic(1) ti col fc rgb immcolor, '' u 3 ti col fc rgb zeropagecolor, '' u 4 ti col fc rgb absolutecolor, '' u 5 ti col fc rgb mixed
